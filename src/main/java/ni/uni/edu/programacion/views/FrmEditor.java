...
private int countTab;
    ...
    private void initComponents() {
        ...
        mniNew.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Webp.net-resizeimage.png"))); // NOI18N
        mniNew.setText("new");
        ...
        setSize(new java.awt.Dimension(465, 408));
...
int option = JOptionPane.showConfirmDialog(null, 
        "Are you sure to delete this tab","Confirm dialog",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE);
if(option== 1){
    return;
}
